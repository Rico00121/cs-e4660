...
# Scenario 2: Failure started 5 minute ago (tests real-time detection)
def scenario_failure_at_5min():
    """Normal for 25 minutes, failure begins 5 minute ago"""
    print("\nScenario 2: Failure started 5 minute ago")
    # Normal phase (30 → 5 minutes ago)
    ...
    # Failure phase (last 5 minute → now)
...
if __name__ == "__main__":
    ...
    print("  2 - Failure started 5 minute ago")
